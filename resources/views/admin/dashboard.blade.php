...
@section('content')
    <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
        <div class="col-span-12 space-y-4 sm:space-y-5 lg:col-span-12 lg:space-y-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-6 sm:gap-5 lg:gap-6">                
                <div class="grid grid-cols-1 gap-4 sm:col-span-3 sm:grid-cols-3 sm:gap-5 lg:gap-6">
                    ...
                    <div class="card justify-center p-4.5">
                        ...
                        <div>
                            ...
                            <p class="text-xs+ line-clamp-1">Active Users</p>
                        </div>
                        <div
                    ...
                    <div class="card justify-center p-4.5">
                        ...
                        <div>
                            ...
                            <p class="text-xs+ line-clamp-1">Blocked Users</p>
                        </div>
                        <div
                            class="mask is-star flex h-10 w-10 shrink-0 items-center justify-center bg-info"
                        >
                    ...
                    <div class="card justify-center p-4.5">
                        ...
                        <div>
                            ...
                            <p class="text-xs+ line-clamp-1">Pending Withdrawal</p>
                        </div>
                        <div
                    ...
                    <div class="card justify-center p-4.5">
                        ...
                        <div>
                            ...
                            <p class="text-xs+ line-clamp-1">Pending Fund Request</p>
                        </div>
                        <div
                            class="mask is-star flex h-10 w-10 shrink-0 items-center justify-center bg-success">
                            <svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="card justify-center p-4.5">
                        ...
                        <div>
                            ...
                            <p class="text-xs+ line-clamp-1">Total Direct Income Paid</p>
                        </div>
                        <div
                            class="mask is-star flex h-10 w-10 shrink-0 items-center justify-center bg-info"
                        >
                    ...
                    <div class="card justify-center p-4.5">
                        ...
                        <div>
                            ...
                            <p class="text-xs+ line-clamp-1">Total Binary Income Paid</p>
                        </div>
                        <div
                            class="mask is-star flex h-10 w-10 shrink-0 items-center justify-center bg-secondary"
                        >
                    ...
                    <div class="card justify-center p-4.5">
                        ...
                        <div>
                            ...
                            <p class="text-xs+ line-clamp-1">Total ROI Income Paid</p>
                        </div>
                        <div
                    ...
                    <div class="card justify-center p-4.5">
                        ...
                        <div>
                            ...
                            <p class="text-xs+ line-clamp-1">Total Paid Income</p>
                        </div>
                        <div
                            class="mask is-star flex h-10 w-10 shrink-0 items-center justify-center bg-secondary"
                        >
                    ...
                    <div class="card justify-center p-4.5">
                        ...
                        <div>
                            ...
                            class="text-base font-semibold text-slate-700 dark:text-navy-100"
                            >
                            ${{ $totalUsersAccountWalletBalance }}
                            </p>
                            <p class="text-xs+ line-clamp-1">Total User Account Wallet Balance</p>
                        </div>
                        <div
                            class="mask is-star flex h-10 w-10 shrink-0 items-center justify-center bg-info"
                        >
                    ...
                    <div class="card justify-center p-4.5">
                        ...
                        <div>
                            ...
                            class="text-base font-semibold text-slate-700 dark:text-navy-100"
                            >
                            ${{ $totalUsersPurchaseWalletBalance }}
                            </p>
                            <p class="text-xs+ line-clamp-1">Total User Purchase Wallet Balance</p>
                        </div>
                        <div
                            class="mask is-star flex h-10 w-10 shrink-0 items-center justify-center bg-warning"
                        >
                    ...
                    <div class="card justify-center p-4.5">
                        ...
                        <div>
                            ...
                            <p class="text-xs+ line-clamp-1">Upcoming Withdrawal</p>
                        </div>
                        <div
                            class="mask is-star flex h-10 w-10 shrink-0 items-center justify-center bg-warning"
                        >
                    ...
                    <!-- The Modal -->
                    <div id="myModal" class="kmmodal">

                    <!-- Modal content -->
                    <div class="kmmodal-content">
                        <span class="kmclose">&times;</span>
...
var span = document.getElementsByClassName("kmclose")[0];
