...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('website-assets/images/favicon.png?v=20230211005214') }}" />
  ...
  <body x-data class="is-header-blur" x-bind="$store.global.documentBody">
    ...
    <div
      id="root"
      class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" style="background-image:url({{ asset('website-assets/images/background/bg-3.jpg?v=20230211005214') }});"
      x-cloak
    >
      <main class="grid w-full grow grid-cols-1 place-items-center">
        <div class="w-full max-w-[26rem] p-4 sm:px-5">
          <div class="text-center">
            <img
              class="mx-auto h-16"
              src="{{ asset('website-assets/images/logo-white.png?v=20230211005214') }}"
              alt="logo"
            />
            <div class="mt-4">
              <h2
