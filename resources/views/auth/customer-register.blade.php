...
<head>
  ...
  <body x-data class="is-header-blur" x-bind="$store.global.documentBody">
    ...
    <div
      id="root"
      class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" style="background-image:url({{ asset('website-assets/images/background/bg-3.jpg?v=20230127224926') }});"
      x-cloak
    >
        ...
        <div class="w-full max-w-[26rem] p-4 sm:px-5">
          <div class="text-center">
            <img
              ...
              src="{{ asset('website-assets/images/logo-white.png?v=20230127224926') }}"
              alt="logo"
            />
            <div class="mt-4">
              <h2
