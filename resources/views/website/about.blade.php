    ...
    <body id="bg"> 
        <div class="page-wraper"> 
                ...
                <div class="main-bar header-middle bg-white">
                    <div class="container">
                        <div class="logo-header">
                            <a href="{{ url('/') }}">
                                <img src="{{ asset('website-assets/images/logo-blue.png?v=20230127233845') }}" width="216" height="37" alt="" />
                            </a>
                        </div>
            ...
            <div class="page-content">
                ...
                <!-- INNER PAGE BANNER -->
                <div class="wt-bnr-inr overlay-wraper" style="background-image:url({{ asset('website-assets/images/banner/about-banner.jpg?v=20230127233845') }});">
                ...
                <div class="section-full p-tb100">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="wt-media">
                                    <img src="{{ asset('website-assets/images/banner/pic3.jpg?v=20230127233845') }}" alt="" class="img-responsive"/>
                                </div>
                            </div>
                        </div>
                    </div>
