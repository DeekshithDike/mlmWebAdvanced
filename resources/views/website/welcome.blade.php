    ...
    <body id="bg"> 
        <div class="page-wraper"> 
                    ...
                    <div class="main-bar">
                        <div class="container">                            
                            <div class="logo-header mostion">
                                <a href="{{ url('/') }}">
                                    <img src="{{ asset('website-assets/images/logo-white.png?v=20230127184122') }}" width="230" height="67" alt="" />
                                </a>
                            </div>
            ...
            <div class="page-content">
                    ...
                    <div class="tp-banner-container">
                        <div class="tp-banner" >
                            ...
                            <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                                    <ul>
                                        <!-- SLIDE 1 -->	
                                        <li data-index="rs-1000" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="{{ asset('website-assets/images/main-slider/slider2/slide1.jpg?v=20230127184122') }}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                        <!-- MAIN IMAGE -->
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/slide1.jpg?v=20230127184122') }}"  alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina/>
                                        <!-- LAYERS -->
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/earth.png?v=20230127184122') }}" alt="" class="spin-city">
                                        </div>
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/bitcoin.png?v=20230127184122') }}" alt="">
                                        </div>  
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/earth2.png?v=20230127184122') }}" alt="" class="spin-city">
                                        </div>
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/earth2-shadow.png?v=20230127184122') }}" alt="">
                                        </div>  
                                        ...
                                        style="z-index: 16;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/rocket.png?v=20230127184122') }}" alt="" class="floating">
                                        </div> 
                                        ...
                                        style="z-index: 15;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/fire.gif?v=20230127184122') }}" alt="" class="floating">
                                        </div>
                                        ...
                                        style="z-index: 12;">
                                        <div class="coin-slide bg-full-width bg-repeat-y coin-slide-rotate" style="background-image:url({{ asset('website-assets/images/main-slider/slider2/coin-sky.png?v=20230127184122') }});height:100vh;"></div>
                                        </div>    
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/rock.png?v=20230127184122') }}" alt="">
                                        </div>
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/agent.png?v=20230127184122') }}" alt="">
                                        </div>  
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/plant.png?v=20230127184122') }}" alt="">
                                        </div> 
                                    </li>
                        ...
                        <div class="ti_wrapper">             
                            <div class="ti_slide">
                                <div class="ti_content"> 
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/bitcoin.png?v=20230127184122') }}" alt=""><span>BTC: </span><span>$ 10,633.1</span><span class="text-yellow p-lr5">0.97 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/bitcoin.png?v=20230127184122') }}" alt=""><span>BTC: </span><span>¥ 68,008.1</span><span class="text-danger p-lr5">0.00 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/bitcoin.png?v=20230127184122') }}" alt=""><span>BTC: </span><span>€ 8,699.23</span><span class="text-white p-lr5">1.08 %</span></a></div>
                                    
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/Ethereum.png?v=20230127184122') }}" alt=""><span>ETH: </span><span>Ƀ 0.08160</span><span class="text-green p-lr5">-0.28 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/Ethereum.png?v=20230127184122') }}" alt=""><span>ETH: </span><span>$ 867.93</span><span class="text-danger p-lr5">-0.60 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/Ethereum.png?v=20230127184122') }}" alt=""><span>ETH: </span><span>¥ 5,549.46</span><span class="text-white p-lr5">-0.28 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/Ethereum.png?v=20230127184122') }}" alt=""><span>ETH: </span><span>€ 709.94</span><span class="text-gray p-lr5">0.26 %</span></a></div>
                                    
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/monero.png?v=20230127184122') }}" alt=""><span>XMR: </span><span>Ƀ 0.0276</span><span class="text-green p-lr5">1.25 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/monero.png?v=20230127184122') }}" alt=""><span>XMR: </span><span>$ 295.33</span><span class="text-light-blue p-lr5">0.89 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/monero.png?v=20230127184122') }}" alt=""><span>XMR: </span><span>¥ 1,883.14</span><span class="text-green p-lr5">0.25 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/monero.png?v=20230127184122') }}" alt=""><span>XMR: </span><span>€ 240.56</span><span class="text-red p-lr5">-0.40 %</span></a></div>
                                    
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/litecoin.png?v=20230127184122') }}" alt=""><span>LTC: </span><span>Ƀ 0.01956</span><span class="text-danger p-lr5">-0.20 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/litecoin.png?v=20230127184122') }}" alt=""><span>LTC: </span><span>$ 208.06</span><span class="text-green p-lr5">-1.97 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/litecoin.png?v=20230127184122') }}" alt=""><span>LTC: </span><span>¥ 1,330.24</span><span class="text-white p-lr5">-0.20 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/litecoin.png?v=20230127184122') }}" alt=""><span>LTC: </span><span>€ 169.91</span><span class="text-yellow p-lr5">-1.29 %</span></a></div>
                                    
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/DigitalCash.png?v=20230127184122') }}" alt=""><span>DASH: </span><span>Ƀ 0.05590</span><span class="text-white p-lr5">0.26 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/DigitalCash.png?v=20230127184122') }}" alt=""><span>DASH: </span><span>$ 594.64</span><span class="text-green p-lr5">0.37 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/DigitalCash.png?v=20230127184122') }}" alt=""><span>DASH: </span><span>¥ 3,801.65</span><span class="text-red p-lr5">0.99 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/DigitalCash.png?v=20230127184122') }}" alt=""><span>DASH: </span><span>€ 486.29</span><span class="text-yellow p-lr5">-10.18 %</span></a></div>
                                </div>                                     
                            </div>
                    </div>
                    </div>        
                ...
                <div id="aboutUs" class="section-full home-about-section p-t80 bg-no-repeat bg-bottom-right"  style="background-image:url({{ asset('website-assets/images/background/bg-coin.png?v=20230127184122') }})">
                    <div class="container-fluid ">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="wt-box text-right">
                                    <img src="{{ asset('website-assets/images/background/bg-laptop.png?v=20230127184122') }}" alt=""> 
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="section-content no-col-gap">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-29.png?v=20230127184122') }}" alt=""></a>
                                        </div>
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-28.png?v=20230127184122') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content ">
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-17.png?v=20230127184122') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-19.png?v=20230127184122') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-12.png?v=20230127184122') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-38.png?v=20230127184122') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                ...
                <div class="section-full p-t50 p-b50 overlay-wraper bg-parallax clouds1 bg-repeat"  data-stellar-background-ratio="0.5" style="background-image:url({{ asset('website-assets/images/background/bg-9.jpg?v=20230127184122') }});">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="rocket-pic">
                                    <div class="rocket-animation ">
                                        <img src="{{ asset('website-assets/images/rocket.png?v=20230127184122') }}" alt="" class="floating" />
                                        <div class="rocket-fire"> <img src="{{ asset('website-assets/images/fire.gif?v=20230127184122') }}" alt="" class="floating"/></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="section-content no-col-gap">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 step-number-block">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-4.png?v=20230127184122') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                ...
                <div id="trading" class="section-full  p-tb80 bg-full-height bg-repeat-x graph-slide-image" style="background-image:url({{ asset('website-assets/images/background/bg-1.jpg?v=20230127184122') }});">
                                ...
                                <div class="col-md-6 col-sm-6 bg-secondry">
                                    <div class="section-content p-b100 p-t150 p-r30 clearfix">
                                        <div class="wt-left-part any-query">
                                            <img src="{{ asset('website-assets/images/any-query.png?v=20230127184122') }}" alt="">
                                            <br />
                                            <br />
                                ...
                                <div class="col-md-6 col-sm-6 bg-primary">
                                    <div class="section-content p-b100 p-t150 p-l30 clearfix">
                                        <div class="wt-right-part any-query">
                                            <img src="{{ asset('website-assets/images/any-query-contact.png?v=20230127184122') }}" alt="">
                                            <br />
                                            <br />
                                            <div class="text-center">
                ...
                <!-- SECTION CONTENT START -->
                <div id="faq" class="section-full  p-tb80 bg-full-height bg-repeat-x graph-slide-image" style="background-image:url({{ asset('website-assets/images/background/bg-1.jpg?v=20230127184122') }});">
                        ...
                        <div id="no-more-tables">
                            <div class="row">
                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/bitcoin.png?v=20230127184122') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Bitcoin </p>
                                </div>

                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/ethereum.png?v=20230127184122') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Ethereum </p>
                                </div>

                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/doge.png?v=20230127184122') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Doge Coin </p>
                                </div>

                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/litecoin.png?v=20230127184122') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Litecoin </p>
                                </div>
                            
                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/shibainu.png?v=20230127184122') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Shiba Inu </p>
                                </div>

                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/tether.png?v=20230127184122') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Tether </p>
                                </div>

                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/matic.png?v=20230127184122') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Matic </p>
                                </div>
                            </div>
                ...
                <div class="section-full  p-tb80 bg-full-height bg-repeat-x graph-slide-image" style="background-image:url({{ asset('website-assets/images/background/bg-1.jpg?v=20230127184122') }});">
                    <div class="container">
                        <!-- TITLE START-->
                        <div class="section-head text-center">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-6 step-number-block">
                                    <div class="wt-icon-box-wraper center p-a30 bg-white m-a5">
                                        <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/security/Lets-Encrypt-Logo.png?v=20230127184122') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 step-number-block">
                                    <div class="wt-icon-box-wraper center p-a30 bg-white m-a5">
                                        <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/security/Cloudflare-Logo.png?v=20230127184122') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 step-number-block">
                                    <div class="wt-icon-box-wraper center p-a30 bg-white m-a5">
                                        <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/security/ncl.png?v=20230127184122') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 step-number-block">
                                    <div class="wt-icon-box-wraper center p-a30 bg-white m-a5">
                                        <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/security/duoLogo-web.png?v=20230127184122') }}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script  src="{{ asset('website-assets/plugins/revolution/revolution/js/jquery.themepunch.tools.min.js?v=20230127184122') }}"></script>
        <script  src="{{ asset('website-assets/plugins/revolution/revolution/js/jquery.themepunch.revolution.min.js?v=20230127184122') }}"></script>

        <!-- SLIDER REVOLUTION 5.0 EXTENSIONS  (Load Extensions only on Local File Systems !  The following part can be removed on Server for On Demand Loading) -->	
        <script  src="{{ asset('website-assets/plugins/revolution/revolution/js/extensions/revolution-plugin.js?v=20230127184122') }}"></script>

        <!-- REVOLUTION SLIDER FUNCTION  ===== -->
        <script   src="{{ asset('website-assets/js/rev-script-1.js?v=20230127184122') }}"></script>
    </body>    
</html>
