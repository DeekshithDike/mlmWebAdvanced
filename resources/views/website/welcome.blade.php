...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- FAVICONS ICON -->
        <link rel="shortcut icon" type="image/x-icon" href="{{ asset('website-assets/images/favicon.png?v=20230127224926') }}" />
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/css/bootstrap.min.css?v=20230127224926') }}">
        <!-- FONTAWESOME STYLE SHEET -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/css/fontawesome/css/font-awesome.min.css?v=20230127224926') }}" />
        <!-- FLATICON STYLE SHEET -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/css/flaticon.min.css?v=20230127224926') }}">
        <!-- ANIMATE STYLE SHEET --> 
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/css/animate.min.css?v=20230127224926') }}">
        <!-- OWL CAROUSEL STYLE SHEET -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/css/owl.carousel.min.css?v=20230127224926') }}">
        <!-- BOOTSTRAP SELECT BOX STYLE SHEET -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/css/bootstrap-select.min.css?v=20230127224926') }}">
        <!-- MAGNIFIC POPUP STYLE SHEET -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/css/magnific-popup.min.css?v=20230127224926') }}">
        <!-- LOADER STYLE SHEET -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/css/loader.min.css?v=20230127224926') }}">    
        <!-- MAIN STYLE SHEET -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/css/style.css?v=20230127224926') }}">
        <!-- THEME COLOR CHANGE STYLE SHEET -->
        <link rel="stylesheet" class="skin" type="text/css" href="{{ asset('website-assets/css/skin/skin-1.css?v=20230127224926') }}">
        <!-- CUSTOM  STYLE SHEET -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/css/custom.css?v=20230127224926') }}">
        <!-- SIDE SWITCHER STYLE SHEET -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/css/switcher.css?v=20230127224926') }}">

        
        <!-- REVOLUTION SLIDER CSS -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/plugins/revolution/revolution/css/settings.css?v=20230127224926') }}">
        <!-- REVOLUTION NAVIGATION STYLE -->
        <link rel="stylesheet" type="text/css" href="{{ asset('website-assets/plugins/revolution/revolution/css/navigation.css?v=20230127224926') }}">
    ...
    <body id="bg"> 
        <div class="page-wraper"> 
                    ...
                    <div class="main-bar">
                        <div class="container">                            
                            <div class="logo-header mostion">
                                <a href="{{ url('/') }}">
                                    <img src="{{ asset('website-assets/images/logo-white.png?v=20230127224926') }}" width="230" height="67" alt="" />
                                </a>
                            </div>
            ...
            <div class="page-content">
                        ...
                        <div class="tp-banner" >
                            ...
                            <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                                    <ul>
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/earth.png?v=20230127224926') }}" alt="" class="spin-city">
                                        </div>
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/bitcoin.png?v=20230127224926') }}" alt="">
                                        </div>  
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/earth2.png?v=20230127224926') }}" alt="" class="spin-city">
                                        </div>
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/earth2-shadow.png?v=20230127224926') }}" alt="">
                                        </div>  
                                        ...
                                        style="z-index: 16;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/rocket.png?v=20230127224926') }}" alt="" class="floating">
                                        </div> 
                                        ...
                                        style="z-index: 15;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/fire.gif?v=20230127224926') }}" alt="" class="floating">
                                        </div>
                                        ...
                                        style="z-index: 12;">
                                        <div class="coin-slide bg-full-width bg-repeat-y coin-slide-rotate" style="background-image:url({{ asset('website-assets/images/main-slider/slider2/coin-sky.png?v=20230127224926') }});height:100vh;"></div>
                                        </div>    
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/rock.png?v=20230127224926') }}" alt="">
                                        </div>
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/agent.png?v=20230127224926') }}" alt="">
                                        </div>  
                                        ...
                                        style="z-index: 13;">
                                        <img src="{{ asset('website-assets/images/main-slider/slider2/plant.png?v=20230127224926') }}" alt="">
                                        </div> 
                                    </li>
                        ...
                        <div class="ti_wrapper">             
                            <div class="ti_slide">
                                <div class="ti_content"> 
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/bitcoin.png?v=20230127224926') }}" alt=""><span>BTC: </span><span>$ 10,633.1</span><span class="text-yellow p-lr5">0.97 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/bitcoin.png?v=20230127224926') }}" alt=""><span>BTC: </span><span>¥ 68,008.1</span><span class="text-danger p-lr5">0.00 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/bitcoin.png?v=20230127224926') }}" alt=""><span>BTC: </span><span>€ 8,699.23</span><span class="text-white p-lr5">1.08 %</span></a></div>
                                    
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/Ethereum.png?v=20230127224926') }}" alt=""><span>ETH: </span><span>Ƀ 0.08160</span><span class="text-green p-lr5">-0.28 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/Ethereum.png?v=20230127224926') }}" alt=""><span>ETH: </span><span>$ 867.93</span><span class="text-danger p-lr5">-0.60 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/Ethereum.png?v=20230127224926') }}" alt=""><span>ETH: </span><span>¥ 5,549.46</span><span class="text-white p-lr5">-0.28 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/Ethereum.png?v=20230127224926') }}" alt=""><span>ETH: </span><span>€ 709.94</span><span class="text-gray p-lr5">0.26 %</span></a></div>
                                    
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/monero.png?v=20230127224926') }}" alt=""><span>XMR: </span><span>Ƀ 0.0276</span><span class="text-green p-lr5">1.25 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/monero.png?v=20230127224926') }}" alt=""><span>XMR: </span><span>$ 295.33</span><span class="text-light-blue p-lr5">0.89 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/monero.png?v=20230127224926') }}" alt=""><span>XMR: </span><span>¥ 1,883.14</span><span class="text-green p-lr5">0.25 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/monero.png?v=20230127224926') }}" alt=""><span>XMR: </span><span>€ 240.56</span><span class="text-red p-lr5">-0.40 %</span></a></div>
                                    
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/litecoin.png?v=20230127224926') }}" alt=""><span>LTC: </span><span>Ƀ 0.01956</span><span class="text-danger p-lr5">-0.20 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/litecoin.png?v=20230127224926') }}" alt=""><span>LTC: </span><span>$ 208.06</span><span class="text-green p-lr5">-1.97 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/litecoin.png?v=20230127224926') }}" alt=""><span>LTC: </span><span>¥ 1,330.24</span><span class="text-white p-lr5">-0.20 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/litecoin.png?v=20230127224926') }}" alt=""><span>LTC: </span><span>€ 169.91</span><span class="text-yellow p-lr5">-1.29 %</span></a></div>
                                    
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/DigitalCash.png?v=20230127224926') }}" alt=""><span>DASH: </span><span>Ƀ 0.05590</span><span class="text-white p-lr5">0.26 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/DigitalCash.png?v=20230127224926') }}" alt=""><span>DASH: </span><span>$ 594.64</span><span class="text-green p-lr5">0.37 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/DigitalCash.png?v=20230127224926') }}" alt=""><span>DASH: </span><span>¥ 3,801.65</span><span class="text-red p-lr5">0.99 %</span></a></div>
                                    <div class="ti_news"><a href="#"><img src="{{ asset('website-assets/images/coin-icon/DigitalCash.png?v=20230127224926') }}" alt=""><span>DASH: </span><span>€ 486.29</span><span class="text-yellow p-lr5">-10.18 %</span></a></div>
                                </div>                                     
                            </div>
                    </div>
                    </div>        
                ...
                <div id="aboutUs" class="section-full home-about-section p-t80 bg-no-repeat bg-bottom-right"  style="background-image:url({{ asset('website-assets/images/background/bg-coin.png?v=20230127224926') }})">
                    <div class="container-fluid ">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="wt-box text-right">
                                    <img src="{{ asset('website-assets/images/background/bg-laptop.png?v=20230127224926') }}" alt=""> 
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="section-content no-col-gap">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-29.png?v=20230127224926') }}" alt=""></a>
                                        </div>
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-28.png?v=20230127224926') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content ">
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-17.png?v=20230127224926') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-19.png?v=20230127224926') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-12.png?v=20230127224926') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                                ...
                                <div class="col-md-4 col-sm-6 animate_line">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-38.png?v=20230127224926') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                ...
                <div class="section-full p-t50 p-b50 overlay-wraper bg-parallax clouds1 bg-repeat"  data-stellar-background-ratio="0.5" style="background-image:url({{ asset('website-assets/images/background/bg-9.jpg?v=20230127224926') }});">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="rocket-pic">
                                    <div class="rocket-animation ">
                                        <img src="{{ asset('website-assets/images/rocket.png?v=20230127224926') }}" alt="" class="floating" />
                                        <div class="rocket-fire"> <img src="{{ asset('website-assets/images/fire.gif?v=20230127224926') }}" alt="" class="floating"/></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="section-content no-col-gap">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 step-number-block">
                                    <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                        <div class="icon-lg text-primary m-b20">
                                            <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/icon/pick-4.png?v=20230127224926') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                ...
                <div id="trading" class="section-full  p-tb80 bg-full-height bg-repeat-x graph-slide-image" style="background-image:url({{ asset('website-assets/images/background/bg-1.jpg?v=20230127224926') }});">
                                ...
                                <div class="col-md-6 col-sm-6 bg-secondry">
                                    <div class="section-content p-b100 p-t150 p-r30 clearfix">
                                        <div class="wt-left-part any-query">
                                            <img src="{{ asset('website-assets/images/any-query.png?v=20230127224926') }}" alt="">
                                            <br />
                                            <br />
                                ...
                                <div class="col-md-6 col-sm-6 bg-primary">
                                    <div class="section-content p-b100 p-t150 p-l30 clearfix">
                                        <div class="wt-right-part any-query">
                                            <img src="{{ asset('website-assets/images/any-query-contact.png?v=20230127224926') }}" alt="">
                                            <br />
                                            <br />
                                            <div class="text-center">
                ...
                <!-- SECTION CONTENT START -->
                <div id="faq" class="section-full  p-tb80 bg-full-height bg-repeat-x graph-slide-image" style="background-image:url({{ asset('website-assets/images/background/bg-1.jpg?v=20230127224926') }});">
                        ...
                        <div id="no-more-tables">
                            <div class="row">
                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/bitcoin.png?v=20230127224926') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Bitcoin </p>
                                </div>

                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/ethereum.png?v=20230127224926') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Ethereum </p>
                                </div>

                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/doge.png?v=20230127224926') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Doge Coin </p>
                                </div>

                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/litecoin.png?v=20230127224926') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Litecoin </p>
                                </div>
                            
                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/shibainu.png?v=20230127224926') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Shiba Inu </p>
                                </div>

                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/tether.png?v=20230127224926') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Tether </p>
                                </div>

                                <div class="text-center col-6 col-md-3">
                                    <img src="{{ asset('website-assets/images/coin-icon/matic.png?v=20230127224926') }}" width="72" height="72" class="p-r10" alt="">
                                    <p> Matic </p>
                                </div>
                            </div>
                ...
                <div class="section-full  p-tb80 bg-full-height bg-repeat-x graph-slide-image" style="background-image:url({{ asset('website-assets/images/background/bg-1.jpg?v=20230127224926') }});">
                    <div class="container">
                        <!-- TITLE START-->
                        <div class="section-head text-center">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-6 step-number-block">
                                    <div class="wt-icon-box-wraper center p-a30 bg-white m-a5">
                                        <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/security/Lets-Encrypt-Logo.png?v=20230127224926') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 step-number-block">
                                    <div class="wt-icon-box-wraper center p-a30 bg-white m-a5">
                                        <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/security/Cloudflare-Logo.png?v=20230127224926') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 step-number-block">
                                    <div class="wt-icon-box-wraper center p-a30 bg-white m-a5">
                                        <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/security/ncl.png?v=20230127224926') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 step-number-block">
                                    <div class="wt-icon-box-wraper center p-a30 bg-white m-a5">
                                        <a href="#" class="icon-cell"><img src="{{ asset('website-assets/images/security/duoLogo-web.png?v=20230127224926') }}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- FOOTER START -->
            <footer class="site-footer footer-dark bg-no-repeat bg-full-height bg-center "  style="background-image:url({{ asset('website-assets/images/background/footer-bg.jpg?v=20230127224926') }});">
                            ...
                            <div class="col-md-3 col-sm-6">  
                                <div class="widget widget_about">
                                    ...
                                    <div class="logo-footer clearfix p-b15">
                                        <a href="{{ url('/') }}"><img src="{{ asset('website-assets/images/logo-white.png?v=20230127224926') }}" width="230" height="67" alt=""/></a>
                                    </div>
                                    <p>
                                        Krypto Musk is one of the first hybrid trading platform founded by a group of visionaries whose idea was to offer a Hybrid platform available to ordinary people willing to participate in this global investment phenomenon and profit on daily bases our vision is service over sales, honor over hustle and most importantly people over profits.
                                    </p>  
            ...
            <div class="loading-pic">
                <div class="cssload-container">
                    <div class="cssload-dot bg-primary">
                        <img src="{{ asset('website-assets/images/favicon-white.png?v=20230127224926') }}" width="230" height="67" alt="" />
                    </div>
        ...
        <!-- JAVASCRIPT  FILES ========================================= --> 
        <script src="{{ asset('website-assets/js/jquery-1.12.4.min.js?v=20230127224926') }}"></script><!-- JQUERY.MIN JS -->
        <script   src="{{ asset('website-assets/js/bootstrap.min.js?v=20230127224926') }}"></script><!-- BOOTSTRAP.MIN JS -->

        <script   src="{{ asset('website-assets/js/bootstrap-select.min.js?v=20230127224926') }}"></script><!-- FORM JS -->
        <script   src="{{ asset('website-assets/js/jquery.bootstrap-touchspin.min.js?v=20230127224926') }}"></script><!-- FORM JS -->

        <script   src="{{ asset('website-assets/js/magnific-popup.min.js?v=20230127224926') }}"></script><!-- MAGNIFIC-POPUP JS -->

        <script   src="{{ asset('website-assets/js/waypoints.min.js?v=20230127224926') }}"></script><!-- WAYPOINTS JS -->
        <script   src="{{ asset('website-assets/js/counterup.min.js?v=20230127224926') }}"></script><!-- COUNTERUP JS -->
        <script   src="{{ asset('website-assets/js/waypoints-sticky.min.js?v=20230127224926') }}"></script><!-- COUNTERUP JS -->

        <script  src="{{ asset('website-assets/js/isotope.pkgd.min.js?v=20230127224926') }}"></script><!-- MASONRY  -->

        <script   src="{{ asset('website-assets/js/owl.carousel.min.js?v=20230127224926') }}"></script><!-- OWL  SLIDER  -->

        <script   src="{{ asset('website-assets/js/stellar.min.js?v=20230127224926') }}"></script><!-- PARALLAX BG IMAGE   --> 
        <script   src="{{ asset('website-assets/js/scrolla.min.js?v=20230127224926') }}"></script><!-- ON SCROLL CONTENT ANIMTE   -->

        <script   src="{{ asset('website-assets/js/custom.js?v=20230127224926') }}"></script><!-- CUSTOM FUCTIONS  -->
        <script   src="{{ asset('website-assets/js/shortcode.js?v=20230127224926') }}"></script><!-- SHORTCODE FUCTIONS  -->
        <script   src="{{ asset('website-assets/js/switcher.js?v=20230127224926') }}"></script><!-- SWITCHER FUCTIONS  -->
        <script  src="{{ asset('website-assets/js/jquery.bgscroll.js?v=20230127224926') }}"></script><!-- BACKGROUND SCROLL -->
        <script  src="{{ asset('website-assets/js/tickerNews.min.js?v=20230127224926') }}"></script><!-- TICKERNEWS-->
        <!-- TICKERNEWS FUNCTiON -->
        ...
        <script  src="{{ asset('website-assets/plugins/revolution/revolution/js/jquery.themepunch.tools.min.js?v=20230127224926') }}"></script>
        <script  src="{{ asset('website-assets/plugins/revolution/revolution/js/jquery.themepunch.revolution.min.js?v=20230127224926') }}"></script>

        <!-- SLIDER REVOLUTION 5.0 EXTENSIONS  (Load Extensions only on Local File Systems !  The following part can be removed on Server for On Demand Loading) -->	
        <script  src="{{ asset('website-assets/plugins/revolution/revolution/js/extensions/revolution-plugin.js?v=20230127224926') }}"></script>

        <!-- REVOLUTION SLIDER FUNCTION  ===== -->
        <script   src="{{ asset('website-assets/js/rev-script-1.js?v=20230127224926') }}"></script>
    </body>    
</html>
