    ...
    <div>
        <div class="py-5 lg:py-6 flex justify-between">
          ...
          <div class="space-y-2 md:space-y-2">
             <a href="{{ route('customerWithdrawRoiProfit') }}" class="btn bg-primary px-3 py-1 text-xs font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 mr-2">
              WITHDRAW ROI PROFIT
            </a>
          </div>
        </div>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            <div class="my-5 space-y-1 h-8">
              <h2 class="font-medium tracking-wide text-slate-700 line-clamp-1 dark:text-navy-100 lg:text-base">
                ROI Profit Withdrawal Report
              </h2>
              <p>
                List of all ROI profit withdrawal.
              </p>
            </div>
