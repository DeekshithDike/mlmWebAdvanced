            ...
            <div class="card">
              ...
              <div class="p-4 sm:p-5">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <label class="block">
                      <span>Your BTC Address <small class="text-warning">(To update your BTC address contact support.)</small></span>
                      <input
                ...
                @else
                  <form method="POST" action="{{ route('customerBtcAddress') }}">
                      @csrf
                      <div class="grid grid-cols-1 gap-4">
                        <label class="block">
                          <span>Enter BTC Address</span>
                          <input
                              class="form-input mt-1.5 w-full rounded-lg border bg-transparent px-3 py-2 placeholder:text-slate-400/70"
                              placeholder="Enter Address"
                              type="text"
                      ...
                      <p class="text-right mt-4"><strong>Note:</strong> You cannot change the BTC address after submiting.</p>
