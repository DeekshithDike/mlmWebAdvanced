            ...
            <div class="card p-4 sm:p-5">
              <div class="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p class="text-xs+">{{ Auth::user()->login_id }}</p>
                </div>
              </div>
              <ul class="mt-6 space-y-1.5 font-inter font-medium">
                ...
                <li>
                  <a
                    ...
                    href="{{ route('customerChangePassword') }}"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="p-4 sm:p-5">
                ...
                <div class="flex flex-col">
                  ...
                  <div class="avatar mt-1.5 h-20 w-20">
                    ...
                    >
                      <form id="submitCustomerProfilePhoto" method="POST" action="{{ route('submitCustomerProfilePhoto') }}" style="display:none;" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="my-7 h-px bg-slate-200 dark:bg-navy-500"></div>
                    ...
                    <div class="my-7 h-px bg-slate-200 dark:bg-navy-500"></div>
                    <div class="space-y-2">
                        <h2>Country: <span class="text-primary">{{ Auth::user()->country }}</span></h2>
                        <h2>Position: <span class="text-primary">{{ Auth::user()->position }}</span></h2>
                        <h2>Sponsor ID: <span class="text-primary">{{ Auth::user()->sponsor_id }}</span></h2>
                    </div>
              </div>
            </div>
          </div>
    ...
    <script>
        $(document).ready( function () {
            $("#profileFile").change(function () {
                ...
                document.getElementById('submitCustomerProfilePhoto').submit();
            });
        } );
    </script>
@endsection