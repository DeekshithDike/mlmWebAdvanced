    ...
    <div>
        <div class="py-5 lg:py-6 flex justify-between">
          ...
          <div class="space-y-2 md:space-y-2">
            ...
            <a href="{{ route('customerActivateAccount') }}" class="btn bg-success px-3 py-1 text-xs font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90">
              Activate Account
            </a>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
          <div class="card px-4 pb-4 sm:px-5">
            <div class="my-5 space-y-1 h-8">
              ...
              <p>
                List of all affiliate activations.
              </p>
            </div>
