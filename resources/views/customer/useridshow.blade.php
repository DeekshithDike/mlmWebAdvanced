...
<head>
    ...
    <title>Login | {{ config('app.name', 'MLM') }}</title>
    <link rel="icon" type="image/png" href="{{ asset('dashboard-assets/images/favicon.png') }}" />
        ...
        <div class="w-full max-w-[26rem] p-4 sm:px-5">
          <div class="text-center">
            <img
              ...
              src="{{ asset('dashboard-assets/images/app-logo.svg') }}"
              alt="logo"
            />
            <div class="mt-4">
              <h2
