    ...
    <div>
        <div class="py-5 lg:py-6 flex justify-between">
          ...
          <div class="space-y-2 md:space-y-2">
             <a href="{{ route('customerMemberTree') }}" class="btn bg-primary px-3 py-1 text-xs font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 mr-2">
              MEMBERS TREE
            </a>
